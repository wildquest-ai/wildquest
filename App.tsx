...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-4 sm:p-8 bg-[#f8fafc] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:20px_20px]">
      
      {/* Navigation Tabs */}
      <nav className="w-full max-w-md mb-12 bg-white/80 backdrop-blur-sm p-1.5 rounded-2xl shadow-sm border border-gray-100 flex gap-1 sticky top-6 z-40">
        <NavLink
          to="/"
          className={({ isActive }) => `flex-1 py-3 px-6 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 ${
            isActive 
